...
angle: 361 → 65 → 80 → 90
bkb: 20 → 55
new animation, more range
damage: 9 → 10
kbg: 88 → 60

**Jab**
now has p+ jab 3, new angle

### Aerial Attacks

**Neutral Air**
now has clone of Link Nair with his own values
properly lined up hitboxes to his legs
angle: 361 → 55
endlag sped up 1.5
...
angles both made 90
late hit angle: 70 → 90 → 30 → 90
late hit kbg: 80 → 100 → 75
...
**Forward Smash**
now uses P+ forward smash animation with new stats, single hit
fixed animation file (was not applied in 0.4.0)
less endlag
damage: 17
bkb: 10
kbg: 110
...
| Run Speed | 1.65 → 1.77 |
| Dash Speed | 1.5 → 1.9 |
| Ground to Air Momentum | buffed further |
| Gravity | increased |
