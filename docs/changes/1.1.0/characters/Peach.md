...
**Down Air**
multihit angle: 70 → 365
multihit sped up 1.3x, then 1.5x
last hit+endlag slowed .9x

### Smash Attacks

**Up Smash**
damage on hitbox id 0: 15 → 17
id 1/0 kbg: 100 → 110
kbg: 110 → 90
...
endlag sped up 1.25x, then 1.6x
sped up endlag: 1.6 → 1.7
multihit damage: 5 → 2
